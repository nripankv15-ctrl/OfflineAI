...
set "OfflineAI_MstyStudio+Kiwix+Qwen3-4b-Instruct"

:: 2. The Direct Download URL
set "https://drive.google.com/file/d/1vqHV4NmOfKIuvn9jTd4HU6rENhGcJP3-/view?usp=drive_link"

echo [STARTING DOWNLOAD] This may take a while (up to 2.64GB).
